...
const BrandAnalysis = () => {
  ...
  return (
    <Layout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Brand Analysis</h1>
          <p className="text-gray-600 dark:text-gray-400">Brand performance metrics and insights</p>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                  <th className="text-left py-2 px-3 text-gray-700 dark:text-gray-300 font-semibold text-xs">Brand</th>
